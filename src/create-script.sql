...
CREATE INDEX PESSOA_NOME_INDEX ON PEOPLE (NOME);
CREATE INDEX PESSOA_APELIDO_INDEX ON PEOPLE (APELIDO);
CREATE INDEX PESSOA_SEARCH_INDEX ON people USING GIST (BUSCA gist_trgm_ops);
