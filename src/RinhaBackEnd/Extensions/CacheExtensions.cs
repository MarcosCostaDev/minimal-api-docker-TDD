...
{
    public static async Task<T> GetOrCreateAsync<T>(this IDistributedCache cache, string key, Func<T> action, DistributedCacheEntryOptions options) where T : class
    {
        ...
        result = execute is Task ? await execute : execute;
    ...
    public static async Task<string> GetOrCreateStringAsync<T>(this IDistributedCache cache, string key, Func<T> action, DistributedCacheEntryOptions options) where T : class
    {
